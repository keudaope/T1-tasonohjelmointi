...
namespace Prototyyppi
{
    ...
    {
        KOETIEDOT kokeet = new KOETIEDOT();
        public palauteFM()
        {
            InitializeComponent();
        }
        ...
        private void lahetaBT_Click(object sender, EventArgs e)
        {
            ...
            string kurssi = "";
            DateTime aika = DateTime.Now.Date;
            string okieli = "";
            string ika = "";
            ...
            if(etunimi.Trim().Equals("") || sukunimi.Trim().Equals("") || salasana1.Trim().Equals("") || salasana2.Trim().Equals("") || email.Trim().Equals("") || aika.Equals("") || kurssi.Trim().Equals(""))
            {
            ...
            else if(salasana1TB.Text != salasana2TB.Text)
            {
                ...
                String salasana = salasana1;
            }

            else
            {
                Boolean lisaaTiedot = kokeet.lisaaTiedot(etunimi, sukunimi, salasana2, email, ika, kurssi, aika, okieli, huomiota);
                if (lisaaTiedot)
                {
